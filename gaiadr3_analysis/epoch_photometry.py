...
def lightcurve(df:pd.DataFrame, g, bp, rp, g_time, bp_time, rp_time, title:str='Flux Vs. Time', overplot:bool=True, rejectflags: bool=False, period:float=None, xlims:tuple[int|float, int|float]=None, ylims:tuple[int|float, int|float]=None):
    """
    Plot G, Bp and Rp magnitude light curves in time.
