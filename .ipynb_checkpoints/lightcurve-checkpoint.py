...
def plot_lightcurves(df:pd.DataFrame, g, bp, rp, g_time, bp_time, rp_time, title:str='Flux Vs. Time', overplot:bool=True, rejectflags: bool=False, period:float=None, xlim:float=None, ylim:float=None):
